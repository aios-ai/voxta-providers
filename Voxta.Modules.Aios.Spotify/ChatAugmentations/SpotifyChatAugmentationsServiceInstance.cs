            ...
            new ClientUpdateContextMessage
            {
                ...
                [
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("play|pause|stop|continue|toggle|playback|music") ],
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("play|pause|stop|spotify|playback|music|songs?|tracks?|albums?|artists?|playlists?|show?|episode?|genre|volume|loud|louder|quiet|quieter|increase|decrease|reduce") ],
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("surprise|random|select|choose|pick") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                    },
                    new() {
                        ...
                        MatchFilter = [ BuildMatchPattern(string.Join("|", settings.SpecialPlaylists.Keys.Select(Regex.Escape))) ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments = [
                    ...
                    new() {
                        ...
                        MatchFilter = [ BuildMatchPattern("play|music|songs?|tracks?|albums?|artists?|playlists?|show?|episode?|genre") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments = [
                    ...
                    new () {
                        ...
                        MatchFilter = [ BuildMatchPattern("queue|add|to queue|next up") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments = [
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("volume|loud|louder|quiet|quieter|increase|decrease|reduce|(?:turn up)|(?:turn down)") ],
                        FlagsFilter = "playing",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments =
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("seek|skip|jump|forward|backward|go to") ],
                        FlagsFilter = "playing",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments =
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("next|skip|forward|songs?|tracks?|titles?") ],
                        FlagsFilter = "playing",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                    },
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("previous|skip|backward|songs?|tracks?|titles?") ],
                        FlagsFilter = "playing",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                    },
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("repeat|tracks?|context|off|none|disable|enable") ],
                        FlagsFilter = "playing",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments =
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("shuffle|on|off|enable|disable") ],
                        FlagsFilter = "playing",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments =
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern(@"like|favorites?|favourites?|love|save|like|add\s+to\s+(?:favorites?|library|liked\s+songs)") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                    },
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("playlists?|list|show|get|available") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                    },
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("add|playlists?|songs?|tracks?") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments =
                    ...
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("devices?|lists?|show") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                    },
                    new()
                    {
                        ...
                        MatchFilter = [ BuildMatchPattern("transfer|devices?|move|playback") ],
                        FlagsFilter = "spotify_connected",
                        Timing = FunctionTiming.AfterUserMessage,
                        CancelReply = true,
                        Arguments =
