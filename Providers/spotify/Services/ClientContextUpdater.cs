...
{
    public class ClientContextUpdater
    {
        private readonly Guid _sessionId;
        private readonly Action<ClientUpdateContextMessage> _sendAction;
        private readonly bool _enableMatchFilter;
        private readonly string _matchFilterWakeWord;
        public ClientContextUpdater(Guid sessionId, Action<ClientUpdateContextMessage> sendAction, bool enableMatchFilter, string matchFilterWakeWord)
        {
            _sessionId = sessionId;
            _sendAction = sendAction;
            _enableMatchFilter = enableMatchFilter;
            _matchFilterWakeWord = matchFilterWakeWord;
        }

        public void UpdateClientContext(string[] flags, string[] contexts)
        {
            _sendAction(new ClientUpdateContextMessage
            {
            ...
            [
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("play|pause|stop|continue|toggle|playback|music") ] : null,
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("play|pause|stop|spotify|playback|music|songs?|tracks?|albums?|artists?|playlists?|show?|episode?|genre|volume|loud|louder|quiet|quieter|increase|decrease|reduce") ] : null,
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("surprise|random|select|choose|pick") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                },
                new() {
                    ...
                    Layer = "SpotifyControl",
                    ShortDescription = "play a special Spotify playlist like Release Radar, Discover Weekly or Daily Mix",
                    Description = "When {{ user }} asks to play a special playlist generated by Spotify for them, such as Release Radar, Discover Weekly or Daily Mix.",
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("release\\sradar|discover\\sweekly|daily\\smix|mix\\sof\\sthe\\sweek|mixtape") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments = [
                        new FunctionArgumentDefinition {
                            Name = "name",
                            Description = "The name of the special playlist the user requested (e.g., Release Radar, Discover Weekly, Daily Mix 1).",
                            Required = true,
                ...
                new() {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("play|music|songs?|tracks?|albums?|artists?|playlists?|show?|episode?|genre") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments = [
                        ...
                        /*new FunctionArgumentDefinition {
                            Name = "age",
                            Description = "If the user gave any time related information (like: 'newest', 'oldest', 'first', 'most recent' etc.), select one of those two options: 'new' or 'old' which fits the time best. Else ignore it",
                            Required = false,
                            Type = FunctionArgumentType.String,
                        }*/
                    ],
                ...
                new () {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("queue|add|to queue|next up") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments = [
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("volume|loud|louder|quiet|quieter|increase|decrease|reduce|(?:turn up)|(?:turn down)") ] : null,
                    FlagsFilter = "playing",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments =
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("seek|skip|jump|forward|backward|go to") ] : null,
                    FlagsFilter = "playing",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments =
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("next|skip|forward|songs?|tracks?|titles?") ] : null,
                    FlagsFilter = "playing",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                },
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("previous|skip|backward|songs?|tracks?|titles?") ] : null,
                    FlagsFilter = "playing",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                },
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("repeat|tracks?|context|off|none|disable|enable") ] : null,
                    FlagsFilter = "playing",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments =
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("shuffle|on|off|enable|disable") ] : null,
                    FlagsFilter = "playing",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments =
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern(@"like|favorites?|favourites?|love|save|like|add\s+to\s+(?:favorites?|library|liked\s+songs)") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                },
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("playlists?|list|show|get|available") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                },
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("add|playlists?|songs?|tracks?") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments =
                ...
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("devices?|lists?|show") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                },
                new()
                {
                    ...
                    MatchFilter = _enableMatchFilter ? [ BuildMatchPattern("transfer|devices?|move|playback") ] : null,
                    FlagsFilter = "spotify_connected",
                    Timing = FunctionTiming.AfterUserMessage,
                    CancelReply = true,
                    Arguments =
        ...
        {
            if (string.IsNullOrEmpty(_matchFilterWakeWord))
            {
                return $@"\b(?:{pattern})\b";
            }
            else
            {
                return $@"(?i)(?=.*\b{_matchFilterWakeWord}\b)(?:.*\b(?:{pattern})\b)";
            }
        }
